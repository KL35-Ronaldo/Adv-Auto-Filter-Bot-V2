...
async def auto_filter(bot: Client, update: Message):
    ...
    max_results = configs["configs"]["max_results"]
    max_per_page = configs["configs"]["max_per_page"]
...
async def recacher(group_id, ReCacheInvite=True, ReCacheActive=False, bot=Client, update=Message):
